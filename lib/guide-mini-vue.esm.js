...
function patch(vnode, container) {
    ...
    if (shapesFlag & 1 /* ShapeFlags.ELEMENT */) {
        processElement(vnode, container);
    }
    else if (shapesFlag & 2 /* ShapeFlags.STATEFUL_COMPONENT */) {
...
function mountElement(vnode, container) {
    ...
    if (shapesFlag & 4 /* ShapeFlags.TEXT_CHILDREN */) {
        el.textContent = children;
    }
    else if (shapesFlag & 8 /* ShapeFlags.ARRAY_CHILDREN */) {
...
function createVnode(type, props, children) {
    ...
    if (typeof children === 'string') {
        vnode.shapesFlag |= 4 /* ShapeFlags.TEXT_CHILDREN */;
    }
    else if (Array.isArray(children)) {
        vnode.shapesFlag |= 8 /* ShapeFlags.ARRAY_CHILDREN */;
    }
    return vnode;
}
